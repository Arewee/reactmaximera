  ...
  return (
    <div className="home">
      ...
      <div className="home-container">
        ...
        <p className="boxText">För klubbar och föreningar som vill ha en flexibel kollektion av kläder och proudukter</p>
          </div>
          
          <div className="box four">
          <img className="homeBoxImage" src="https://img.freepik.com/free-photo/smiling-woman-using-laptop-computer_171337-19369.jpg?w=2000&t=st=1650377691~exp=1650378291~hmac=ec7ce924f91c81c92e7267b1af50b9fa1a8b5ac4c02e108083e4f57ce1535d90" />
        <h3 className="boxTitle">Webbsupport</h3>
        <p className="boxText">Hjälp med en egen hemsida? <br></br>Med oss kommer du igång!</p>
          </div>
          
        <div className="box five"> 
    
                <p className="MXbannerTextKontakt">Med oss hittar du en fungerande lösning oavsett om det är till ett företag eller förening. Hör av dig med och berätta vad du vill ha hjälp så böjar vi där.   </p>
                <a href="/kontakt">
